...
#ifndef PROJECT_ITERATION3_SRC_LIB_LIBIMGTOOLS_SRC_UI_CTRL_H_
#define PROJECT_ITERATION3_SRC_LIB_LIBIMGTOOLS_SRC_UI_CTRL_H_
 ...
 ******************************************************************************/
/**
 * @brief class that controls the user interface action
 *
 */
class UICtrl {
 public:
  /**
   * @brief GLUI button toggle
   */
...
#endif  /* PROJECT_ITERATION3_SRC_LIB_LIBIMGTOOLS_SRC_UI_CTRL_H_ */
