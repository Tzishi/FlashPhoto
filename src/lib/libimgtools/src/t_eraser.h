...
#ifndef PROJECT_ITERATION3_SRC_LIB_LIBIMGTOOLS_SRC_T_ERASER_H_
#define PROJECT_ITERATION3_SRC_LIB_LIBIMGTOOLS_SRC_T_ERASER_H_
...
#endif  /* PROJECT_ITERATION3_SRC_LIB_LIBIMGTOOLS_SRC_T_ERASER_H_ */
