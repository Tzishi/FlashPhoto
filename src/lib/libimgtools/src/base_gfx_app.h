...
#ifndef PROJECT_ITERATION3_SRC_LIB_LIBIMGTOOLS_SRC_BASE_GFX_APP_H_
#define PROJECT_ITERATION3_SRC_LIB_LIBIMGTOOLS_SRC_BASE_GFX_APP_H_
...
#endif  /* PROJECT_ITERATION3_SRC_LIB_LIBIMGTOOLS_SRC_BASE_GFX_APP_H_ */
