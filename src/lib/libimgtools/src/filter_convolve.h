...
#ifndef PROJECT_ITERATION3_SRC_LIB_LIBIMGTOOLS_SRC_FILTER_CONVOLVE_H_
#define PROJECT_ITERATION3_SRC_LIB_LIBIMGTOOLS_SRC_FILTER_CONVOLVE_H_
...
#endif /* PROJECT_ITERATION3_SRC_LIB_LIBIMGTOOLS_SRC_FILTER_CONVOLVE_H_ */
