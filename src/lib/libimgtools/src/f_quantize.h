...
#ifndef PROJECT_ITERATION3_SRC_LIB_LIBIMGTOOLS_SRC_F_QUANTIZE_H_
#define PROJECT_ITERATION3_SRC_LIB_LIBIMGTOOLS_SRC_F_QUANTIZE_H_
...
#endif  /* PROJECT_ITERATION3_SRC_LIB_LIBIMGTOOLS_SRC_F_QUANTIZE_H_ */
