...
#ifndef PROJECT_ITERATION3_SRC_APP_FLASHPHOTO_SRC_TOOL_FACTORY_H_
#define PROJECT_ITERATION3_SRC_APP_FLASHPHOTO_SRC_TOOL_FACTORY_H_
...
#endif  /* PROJECT_ITERATION3_SRC_APP_FLASHPHOTO_SRC_TOOL_FACTORY_H_ */
